...
#ifndef _GC_KettlerController_h
#define _GC_KettlerController_h 1

class KettlerController : public RealtimeController
{
    Q_DECLARE_TR_FUNCTIONS(KettlerController)

public:
    KettlerController (TrainSidebar *, DeviceConfiguration *);

    Kettler *m_kettler;               // the device itself
